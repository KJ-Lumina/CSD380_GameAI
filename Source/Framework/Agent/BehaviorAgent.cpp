...
BehaviorAgent::BehaviorAgent(const char *type, size_t id, AgentOrganizer* organizer) : Agent(type, id), _organizer{organizer}
{
...
AgentOrganizer* BehaviorAgent::get_organizer()
{
	return _organizer;
}
