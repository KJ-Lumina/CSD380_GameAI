#include <pch.h>
#include "L_RegisterLeftTurn.h"
#include "../GlobalInfo.h"

L_RegisterLeftTurn::L_RegisterLeftTurn()
{}

void L_RegisterLeftTurn::on_enter()
{
	BehaviorNode::on_leaf_enter();
}

void L_RegisterLeftTurn::on_update(float dt)
{
	...
	for (JunctionOrientationPassasge& passages : junction.orientationPassages)
	{
		...
		if (cosTheta > 1.0f - 0.01f && passages.turnDirection == MovementDirection::LEFT)
		{
			auto& bb = agent->get_blackboard();
			bb.set_value("PossibleTurnLeft", true);
			on_success();
			return;
		}
	}
