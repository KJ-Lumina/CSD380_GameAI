#include <pch.h>
#include "L_RegisterStraight.h"
#include "../GlobalInfo.h"

L_RegisterStraight::L_RegisterStraight()
{}

void L_RegisterStraight::on_enter()
{
	BehaviorNode::on_leaf_enter();
}

void L_RegisterStraight::on_update(float dt)
{
	...
	for (JunctionOrientationPassasge& passages : junction.orientationPassages)
	{
		...
		if (cosTheta > 1.0f - 0.01f && passages.isStraightPossible)
		{
			auto& bb = agent->get_blackboard();
			bb.set_value("PossibleForward", true);
			on_success();
			return;
		}
	}
